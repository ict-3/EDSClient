    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("txtDeptId") != null) {
                ...
                //Getting All Employee Details By Age
                infos = ecl.getAllEmployeeDetailsByAgeRange(Integer.valueOf(request.getParameter("start")), Integer.valueOf(request.getParameter("end")));
                //End Getting All Employee Details By Age
            } else {
            ...
            out.println("</select>");
            out.println("</br>");
            out.println("Age: <input type='text' name='start' class='mt-2'>");
            out.println("End: <input type='text' name='end' class='mt-2'>");
            out.println("</br>");
            ...
            if (infos.isEmpty()) {
                ...
                for (Salary info : infos) {
                    ...
                    out.println("</tr>");
                    totalSalary += info.getAmount();
                }
            }
            out.println("<tr>");
            out.println("<td colspan='6' class='text-center'>Total Salary: "+totalSalary+"</td>");
            out.println("</tr>");
            out.println("</table>");
            out.println("</center>");
            out.println("</body>");
